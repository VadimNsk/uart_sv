...
set_property PACKAGE_PIN N16 [get_ports RXCI]
set_property PACKAGE_PIN N17 [get_ports TXDREI]
set_property PACKAGE_PIN N18 [get_ports RXDRNEI]
#
...
set_property IOSTANDARD LVCMOS33 [get_ports TXDREI]
set_property IOSTANDARD LVCMOS33 [get_ports RXDRNEI]
...
#
#set_property IOB true [get_ports {status[TXDRE]}]
set_property IOB true [get_ports {status[3]}]
#set_property IOB true [get_ports {status[RXDRNE]}]
...
set_property IOB true [get_ports TXDREI]
set_property IOB true [get_ports RXDRNEI]
set_property IOB true [get_ports tx_ready]
set_property IOB true [get_ports rx_dout[*]]
set_property IOB true [get_ports rx_valid]
...
set_property DRIVE 12 [get_ports TXDREI]
set_property DRIVE 12 [get_ports RXDRNEI]
...
set_property OFFCHIP_TERM NONE [get_ports TXDREI]
set_property OFFCHIP_TERM NONE [get_ports RXDRNEI]
